...
@section('content')
    ...
    <div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class=" container ">
                <!--begin::Dashboard-->
                <form id="UpdateForm" data-url="{{route('services.update',$service->id)}}">
                    @csrf
                    {{method_field('PUT')}}
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-9">
                                                ...
                                                <input type="text"  name="title_ar" class="form-control" placeholder="Service title Ar" value="{{$service->title_ar}}"/>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-9">
                                                ...
                                                <input type="text"  name="title_en" class="form-control" placeholder="Service title En" value="{{$service->title_en}}"/>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea name="description_ar" class="form-control summernote" id="kt_summernote_1"
                                                          ...
                                                          rows="2">{{$service->description_ar}}</textarea>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea name="description_en" class="form-control summernote" id="kt_summernote_1"
                                                          ...
                                                          rows="2">{{$service->description_en}}</textarea>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-9">
                                                ...
                                                <input type="text"  name="icon" class="form-control" placeholder="Career title" value="{{$service->icon}}"/>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-9">
                                                ...
                                                <select class="form-control select2"  multiple name="tags[]">
                                                    ...
                                                    @foreach($tags as $tag)
                                                        <option value="{{$tag->id}}" {{(in_array($tag->id ,$tagService)) ?'selected':''}}>{{$tag->title_en}}</option>
                                                    @endforeach
		...
		<i class="ki ki-bold-close icon-xs text-muted"></i>
                                        ...
                                        @if(!is_null($service->image))
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="{{asset('storage/'.$service->image)}}" style="width: 100%">
                                                </div>
                                            </div>
