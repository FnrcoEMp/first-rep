                                            ...
                                            <table class="table table-bordered table-vertical-center text-center" >
                                                ...
                                                @foreach($messages as $index => $message)
                                                    <tr id="t-12">
                                                        ...
                                                        <td class=" dt-center">{{$message->First_name}}</td>
                                                        <td class=" dt-center">{{$message->Last_name}}</td>
                                                        <td class=" dt-center">{{$message->email}}</td>
                                                        <td class=" dt-center">{{$message->phone}}</td>
                                                                                                                ...
                                                                                                                <td class=" dt-center">
                                                                                                                    <div class="dropdown">
                                                                                                                        ...
                                                                                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                                                                            ...
                                                                                                                            <a data-toggle="modal" data-target="#exampleModal-{{$message->id}}"  class="dropdown-item"
                                                                                                                               href="">Show Message</a>


                                                                                                                            <a class="dropdown-item del_btn"  data-url="{{route('message.destroy',$message->id)}}" href="#" data-id="12">Delete</a>
